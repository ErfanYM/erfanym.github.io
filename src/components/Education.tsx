        ...
        <div className="flex flex-col gap-10">
          {education.map((entry) => (
            <div key={entry.school} className="relative">
              <span className="absolute -left-10 md:-left-12 top-6 w-3 h-3 rounded-full bg-accentInk ring-4 ring-bg" />

              <div className="rounded-xl border border-line overflow-hidden">
                <div className="bg-gradient-to-r from-accentInk to-accent text-white px-6 py-5">
                  <div className="flex items-start gap-3 mb-2">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="mt-1 shrink-0">
                      <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" />
                      <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2Z" />
                    </svg>
                    <h3 className="font-display text-lg leading-snug">{entry.degree}</h3>
                  </div>
                  <p className="text-sm opacity-90 mb-3">{entry.school}</p>
                  <span className="inline-flex items-center gap-1.5 text-xs px-3 py-1 rounded-full bg-white/20">
                ...
                <div className="px-6 py-4 flex items-center gap-1.5 text-sm text-muted">
                  <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
